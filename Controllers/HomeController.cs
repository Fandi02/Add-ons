...
public class HomeController : Controller
{
    ...
    public HomeController(ILogger<HomeController> logger)
    {
        ...
        _listAplikasi = new List<Aplikasi>(){
            new Aplikasi(1, "ZenMate Free VPN – Best VPN for Edge", "ZenMate VPN - The best free Edge VPN extension to hide your IP. Encrypt your connection & Access websites easily.")
            {
            ...
            new Aplikasi(2, "MetaMask", "MetaMask is a Crypto Wallet and Your Gateway to Web3. Buy, store and send tokens globally. Explore blockchain applications at lightening speed. Choose what to share and what to keep private.")
            {
            ...
            new Aplikasi(3, "NordVPN – VPN Proxy for Privacy & Security", "Get yourself an ultra-fast VPN proxy extension for Microsoft Edge and never stop for anything. Download NordVPN to enjoy fast, private, and secure internet in an instant. It’s an easy-to-use VPN, trusted by millions of users worldwide.")
            {
            ...
            new Aplikasi(4, "IDM Integration Module", "Internet Download Manager (IDM) is a popular tool to increase download speeds by up to 5 times, resume and schedule downloads.")
            {
            ...
            new Aplikasi(5, "The Elder Scrolls V: Skyrim 10th Anniversary", "Personalize Microsoft Edge with a new browser theme inspired by The Elder Scrolls V: Skyrim Anniversary Edition celebrating the 10th Anniversary of the game.")
            {
